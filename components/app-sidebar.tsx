"use client"
//side bar stuff for connection stuff and status symbols
import Link from "next/link"
import Image from "next/image"
import { usePathname } from "next/navigation"
import { Activity, FileText, Settings, BarChart3, Wifi } from "lucide-react"
  ...
  return (
    <aside className="flex h-screen w-60 flex-col border-r border-sidebar-border bg-sidebar">
      <div className="flex items-center gap-3 px-6 py-5">
        <div className="flex size-8 items-center justify-center overflow-hidden rounded-lg border border-sidebar-border bg-white">
          <Image src="/icon-192.png" alt="DAVA logo" width={32} height={32} className="size-8 object-contain" />
        </div>
        <span className="text-lg font-semibold text-sidebar-foreground">DAVA</span>
      </div>
