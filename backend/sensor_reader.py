...
#we're in the big leagues now. Literally only piece of code that was easy to write.
...
class DS18B20Reader:
    ...
    temperature values that drift realistically between 20-65 °C. for the love of god makesure
    you have the sensor properly connected and dont use a hat terminal cus it just makes things worse.
    """
    ...
    def _mock_read(self) -> float:
        ...
        drift = random.uniform(-0.5, 0.7)  # slight upward bias things that indicate heat. (heating)
